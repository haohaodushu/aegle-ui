    ...
    <dl-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
      ...
      <dl-form-item label="活动时间" required>
        <el-col :span="11">
          <dl-form-item prop="date1">
            <aegle-date-picker type="date" placeholder="选择日期" v-model="ruleForm.date1" style="width: 100%" />
          </dl-form-item>
        </el-col>
      ...
      <dl-form-item label="活动性质" prop="type">
        <aegle-checkbox-group v-model="ruleForm.type">
          <aegle-checkbox label="美食/餐厅线上活动" name="type" />
          <aegle-checkbox label="地推活动" name="type" />
          <aegle-checkbox label="线下主题活动" name="type" />
          <aegle-checkbox label="单纯品牌曝光" name="type" />
        </aegle-checkbox-group>
      </dl-form-item>
      <dl-form-item label="特殊资源" prop="resource">
        <aegle-radio-group v-model="ruleForm.resource">
          <aegle-radio label="线上品牌商赞助" />
          <aegle-radio label="线下场地免费" />
        </aegle-radio-group>
      </dl-form-item>
