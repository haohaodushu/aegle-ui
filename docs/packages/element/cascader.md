...
<div class="block">
  ...
  <aegle-cascader
    v-model="value"
    :options="options"
    @change="handleChange"></aegle-cascader>
</div>
<div class="block">
...
```html
<aegle-cascader :options="options"></aegle-cascader>
...
:::demo
```html
<aegle-cascader :options="options" clearable></aegle-cascader>
...
```html
<aegle-cascader :options="options" :show-all-levels="false"></aegle-cascader>
...
```html
<aegle-cascader :props="props"></aegle-cascader>
...
```html
<aegle-cascader :options="options">
...
```html
<aegle-cascader-panel :options="options"></aegle-cascader-panel>
